...
var (
	...
	auctionAddressStr           = "0x1d80315fac6aBd3EfeEbE97dEc44461ba7556160"
	...
	wdelayerAddressStr          = "0x52d3b94181f8654db2530b0fEe1B19173f519C52"
...
func TestMain(m *testing.M) {
	...
	if os.Getenv("INTEGRATION") != "" {
		...
		auctionClient, err = NewAuctionClient(ethereumClientGov, auctionAddressConst, tokenERC777AddressConst)
		if err != nil {
			panic(err)
		}
