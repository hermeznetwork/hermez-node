...
// TokenhezMetaData contains all meta data concerning the Tokenhez contract.
var TokenhezMetaData = &bind.MetaData{
...
// Deprecated: Use TokenhezMetaData.ABI instead.
var TokenhezABI = TokenhezMetaData.ABI
